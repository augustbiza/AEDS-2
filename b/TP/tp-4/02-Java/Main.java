...
class ArvoreBinaria {
    ...
    private boolean pesquisar(String name, No i, StringBuilder caminho) {
        if (i == null) {
            comparacoes++;
            return false;
        }

        int cmp = name.compareTo(i.elemento.getTitle());
        comparacoes++;
        ...
        if(cmp == 0) {
            ...
            caminho.append("esq ");
            return pesquisar(name, i.esq, caminho);
        } 
        else {
            caminho.append("dir ");
            return pesquisar(name, i.dir, caminho);
        }
    }
...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        while(!nome.equals("FIM")) {
            boolean existe = av.pesquisar(nome);
